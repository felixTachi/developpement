...
class DbHandler {
    ...
    /**
     * Méthode getAtransaction
     */
    public function getAllTransaction() {
        $stmt = $this->conn->prepare("SELECT t.idtrans, 
            t.idpaie, 
            t.numquitus, 
            t.nometudiant,
            t.montant,
        ...
        if ($stmt->execute()) {
            $res = array();
            $stmt->bind_result($idpaie, $numquitus, $nometudiant, $montant, $datepaie, $heurepaie, $agence, $ville, $refpaiement, $idetudiant, $annee, $telephone);
            $stmt->fetch();
            $res["idpaie"] = $idpaie;
            $res["numquitus"] = $numquitus;
            $res["nometudiant"] = $nometudiant;
            $res["montant"] = $montant;
            $res["datepaie"] = $datepaie;
            $res["heurepaie"] = $heurepaie;
            $res["agence"] = $agence;
            $res["ville"] = $ville;
            $res["refpaiement"] = $refpaiement;
            $res["annee"] = $annee;
