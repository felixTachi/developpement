                ...
                <div class="panel-heading" style="color:#FFF;background-color:#003366;;width:950px" align="center"><H3>FACULTE DES SCIENCES</H3></div>
                    ...
                    <?php
                        ...
                        foreach($data as $v){ 
                            $i++;
                            if($v['etablissement']="Faculté des Sciences") {?>
                    <tr style="background-color:<?php $couleurs[$i%$nb];?>">
                            <td><?php if($v['etablissement']="Faculté des Sciences") echo $v['numquitus'];?></td>
                            <td><?php if($v['etablissement']="Faculté des Sciences") echo $v['nometudiant'];?></td>
                            <td><?php if($v['etablissement']="Faculté des Sciences") echo $v['montant'];?></td>
                            <td><?php if($v['etablissement']="Faculté des Sciences") echo $v['datepaie']." ".$v['heurepaie'];?></td>
                           <td><?php if($v['etablissement']="Faculté des Sciences") echo $v['telephone'];?></td>
                        </tr>
                        <?php }
                     } ?>
                    </table>
